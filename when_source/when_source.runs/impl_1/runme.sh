...
HD_PWD='C:/Users/toadem/Desktop/comparator/when_source/when_source.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log when_source_beh.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source when_source_beh.tcl -notrace
