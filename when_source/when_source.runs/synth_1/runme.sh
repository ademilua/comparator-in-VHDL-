...
HD_PWD='C:/Projects/DigitalSysDesign/xilinx/when_source/when_source.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log when_source_beh.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source when_source_beh.tcl
