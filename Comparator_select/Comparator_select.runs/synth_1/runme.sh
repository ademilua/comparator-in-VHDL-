...
HD_PWD='C:/Projects/DigitalSysDesign/xilinx/Comparator_select/Comparator_select.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Comparator_select.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Comparator_select.tcl
