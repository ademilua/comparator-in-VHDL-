...
HD_PWD='C:/Projects/DigitalSysDesign/xilinx/Comparator_select/Comparator_select.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Comparator_select.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Comparator_select.tcl -notrace
