...
#
# Generated by export_simulation on Wed Oct 10 16:57:45 +0300 2018
#
################################################################################
...
'-reset_run' switch to the './Adderblock_design.sh' script.

./Adderblock_design.sh -reset_run
...
./Adderblock_design.sh -noclean_files

For more information on the script, please type './Adderblock_design.sh -help'.
