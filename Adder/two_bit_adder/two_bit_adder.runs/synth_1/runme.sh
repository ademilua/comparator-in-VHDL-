...
HD_PWD='P:/Adder/two_bit_adder/two_bit_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Adderblock_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Adderblock_design_wrapper.tcl
