...
HD_PWD='P:/Adder/two_bit_adder/two_bit_adder.runs/Adderblock_design_full_adder_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Adderblock_design_full_adder_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Adderblock_design_full_adder_0_0.tcl
