...
HD_PWD='P:/Adder/two_bit_adder/two_bit_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Adderblock_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Adderblock_design_wrapper.tcl -notrace
