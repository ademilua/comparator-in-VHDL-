...
HD_PWD='C:/Users/toadem/Desktop/comparator/booleanComp/booleanComp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BooleanComp_Source_beh.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BooleanComp_Source_beh.tcl -notrace
