...
HD_PWD='C:/Users/toadem/Desktop/comparator/booleanComp/booleanComp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BooleanComp_Source_beh.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BooleanComp_Source_beh.tcl
